        ...
        for part_name, part_info in source_parts.items():
            if part_name not in target_parts:
                differences.append(Difference(
                    ...
                    source_value={**part_info, "partition_method": source_partitions.get("partition_method", "RANGE")},
                    target_value=None,
        ...
        for part_name, part_info in target_parts.items():
            if part_name not in source_parts:
                differences.append(Difference(
                    ...
                    sub_object_name=part_name,
                    source_value=None,
                    target_value={**part_info, "partition_method": target_partitions.get("partition_method", "RANGE")},
            ...
            if part_name in target_parts:
                ...
                if source_desc != target_desc:
                    differences.append(Difference(
                        ...
                        object_name=table_name,
                        sub_object_name=part_name,
                        source_value={"name": part_name, "description": source_desc, "partition_method": source_partitions.get("partition_method", "RANGE")},
                        target_value={"name": part_name, "description": target_desc, "partition_method": target_partitions.get("partition_method", "RANGE")},
